...
export class mainMap extends Phaser.Scene {
    ...
    create() {
        ...
        this.scale.on('resize', (gameSize) => {
            ...
            createButton.buttonBg.fillStyle(0x0AFC4B, 0.8).fillRoundedRect(newWidth - createButton.buttonBg.width + 125, createButtonPosition, createButton.buttonBg.width, buttonHeight, cornerRadius);
            ...
            createButton.buttonText.setX(newWidth - createButton.buttonBg.width / 2 + 125);
            createButton.buttonText.setY(createButtonPosition + buttonHeight / 2); // Center vertically

            loginButton.buttonBg.clear();
            loginButton.buttonBg.fillStyle(0xFF3D3D, 0.8).fillRoundedRect(newWidth - loginButton.buttonBg.width + 125, loginButtonPosition, loginButton.buttonBg.width, buttonHeight, cornerRadius);
            ...
            // Center the text in the button
            loginButton.buttonText.setX(newWidth - loginButton.buttonBg.width / 2 + 125);
    ...
    update() {
        ...
        createButton(text, yPosition, callback, backgroundColor) {
            ...
            buttonBg.fillRoundedRect(screenWidth - buttonWidth + 125, yPosition, buttonWidth, buttonHeight, cornerRadius); // Align to the right with some padding
            buttonBg.lineStyle(borderWidth, borderColor);  // White border
            buttonBg.strokeRoundedRect(screenWidth - buttonWidth + 125, yPosition, buttonWidth, buttonHeight, cornerRadius);
            ...
            const buttonText = this.add.text(screenWidth - buttonWidth / 2 + 125, yPosition + buttonHeight / 2, text, { 
